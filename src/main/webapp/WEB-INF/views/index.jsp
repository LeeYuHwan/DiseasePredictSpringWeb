...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">감염병별 통계</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">정보 크롤링 하는 중...</h6>
                                    <div class="dropdown no-arrow">                        
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <div class="dropdown-header">(통계) 질병을 선택하세요:</div>
                                            <a class="dropdown-item" href="#" id="ParasiteInfection">기생충감염증</a>
                                            <a class="dropdown-item" href="#" id="HepatitisC">C형 간염</a>
                                            <a class="dropdown-item" href="#" id="RespiratoryInfections">급성호흡기감염증</a>
                                            <a class="dropdown-item" href="#" id="SexInfectiousDisease">성매개감염병</a>
                                            <a class="dropdown-item" href="#" id="EnteroInfections">엔테로바이러스감염증</a>
                                            <a class="dropdown-item" href="#" id="Influenza">인플루엔자</a>
                                            <a class="dropdown-item" href="#" id="IntestinalInfections">장관감염증</a>
                                            <a class="dropdown-item" href="#" id="HFMDisease">합병증동반수족구병</a>
                                            <a class="dropdown-item" href="#" id="ParasiteInfectionsAbroad">해외유입기생충감염증</a>
                                            <div class="dropdown-divider"></div>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    	<a id="info">정보 크롤링 하는 중...</a><br>
                                        <a id="about" target="_blank" rel="nofollow" href="https://undraw.co/">자세히 보기 &rarr;</a>
                                </div>
                            </div>
    ...
    <script src="http://localhost:8080/connect/resources/js/demo/chart-area-demo.js?ver=1"></script>
